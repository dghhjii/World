...
- events.desc：以200个汉字为上限，通常150-200字（描述事件当前进展、关键细节与影响，不要只写一句）。
- factions.currentGoal：以200个汉字为上限，通常100-200字（写明势力当前目标与推进情况）。
- winds.content：以200个汉字为上限，通常150-200字（写明正在传播的具体说法、关键细节与圈层反应）。
- influenceChain.impact：以200个汉字为上限，通常150-200字。
- influenceChain.fallout：以200个汉字为上限，通常150-200字。
- worldTrends.description：以200个汉字为上限，通常150-200字。
